...
public class SwipeRecyclerViewForTask extends RecyclerView {
    ...
    public SwipeRecyclerViewForTask(Context context) {
        this(context, null);
    }

    public SwipeRecyclerViewForTask(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SwipeRecyclerViewForTask(Context context, AttributeSet attrs, int defStyle) {
...
//                if (item != null) {
//                    TaskAdapter.ViewHolder viewHolder = (TaskAdapter.ViewHolder) getChildViewHolder(item);
//                    mCurItemLayout = viewHolder.taskItem;
//                    mTLHidden = mCurItemLayout.findViewById(R.id.task_item_hidden);
//                    mItemDelete = mCurItemLayout.findViewById(R.id.task_item_hidden);
